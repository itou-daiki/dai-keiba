...
### 方法1: オッズ自動取得モード（スクレイピング）🤖

1. **「自動取得モード」ボタンをクリック**

2. **取得元サイトを選択**
   - netkeiba、JRA公式サイト、地方競馬情報サイトから選択

3. **レースページのURLを入力**
   - 例: `https://race.netkeiba.com/race/shutuba.html?race_id=202412050811`
   - netkeibaの出馬表ページまたはレース詳細ページのURL

4. **「オッズを自動取得」ボタンをクリック**
   - 自動的にオッズデータが取得され、入力欄に反映されます
