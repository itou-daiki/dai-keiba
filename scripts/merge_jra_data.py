...
def merge_jra_data(save_dir: str = "/Users/itoudaiki/Program/dai-keiba/data/raw"):
    """
    database_basic.csv + database_details.csv → database.csv
    """
    print(f"\n{'='*80}")
    print("🔗 JRAデータマージ")
    print(f"{'='*80}\n")
    
    basic_path = os.path.join(save_dir, "database_basic.csv")
    details_path = os.path.join(save_dir, "database_details.csv")
    output_path = os.path.join(save_dir, "database.csv")
